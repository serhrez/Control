...
class PredefinedRealm {
    static func populateRealm(_ realm: Realm) {
        ...
        try realm.write {
            ...
            realm.add(project2)
            realm.add(project3)
            let project4 = RlmProject(name: "Inbox2", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            let project5 = RlmProject(name: "Inbox3", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            let project6 = RlmProject(name: "Inbox4", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            let project7 = RlmProject(name: "Inbox5", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            let project8 = RlmProject(name: "Inbox6", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            let project9 = RlmProject(name: "Inbox7", icon: .assetImage(name: "Image", tintHex: "#571cff"), notes: "", color: .hex("#571cff"), date: Date())
            realm.add(project4)
            realm.add(project5)
            realm.add(project6)
            realm.add(project7)
